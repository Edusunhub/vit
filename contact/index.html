                ...
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            ...
                            <a href="./MBARetailManagement" class="dropdown-item">Retail Management</a>
                ...
                <div class="row">
                    <div class="col-lg-6 mt-4">
                        <div class="contact-page mt-3">
                            <!-- <img src="../img/manipal-university-jaipur-rajasthan-banner.webp" alt="Manipal University Image" style="height:450px"> -->
                            <p><i class="fa-solid fa-globe"></i>online.VIT.com</p>
                        </div>
                        <div class="mt-5">
                            ...
                            <div class="linkss">
                                ...
                                <p><a href=""><i class="fa-brands fa-google-plus-g"></i></a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12 col-12 landingform">
                        <div class="content">
                            <div class="form-container p-4 shadow-lg rounded mt-5">
                                <h4 class="text-center mb-4 form-title" style="font-size:30px; color: #004C93;">🎓
                                    Enroll Now</h4>
                                ...
                                <div class="text-center">
                                    <button type="button" class="submit-btn"
                                        style="width:100%; background-Color:#004C93; border:none; border-radius:5px; color:#fff; height:40px;"
